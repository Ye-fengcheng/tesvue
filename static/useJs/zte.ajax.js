 ...
 // }
  ...
  zte.Contants = function () {
	  var systemCode = "UAC";
		...
		if(loca.hash=="#/epmsLogin"){
			returnUrl = loca.origin + loca.pathname +'#/epmsFrame/epmsDeliverConfig/epmsDeliverConfig/myproj_test';
		}
	  var uacPortal = "https://uac.zte.com.cn/portal/login.html?businessSystemCode=" + systemCode + "&url=" + encodeURIComponent(encodeURIComponent(returnUrl));
	  return {
			...
			debugger
	 			if (ret != null && ret.code != null
				    ...
				    zte.user.account = row.account;
					 ...
					 setTimeout(function(){
						 window.location = zte.contants.getPortalUrl();
					 },0)
